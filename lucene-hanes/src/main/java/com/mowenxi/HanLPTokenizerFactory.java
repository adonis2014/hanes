...
public final class HanLPTokenizerFactory extends TokenizerFactory {
    ...
    public Tokenizer create(AttributeFactory factory) {
        return new HanLPTokenizer(HanLP.newSegment().enableOffset(true).enableIndexMode(enableIndexMode), null, enablePorterStemming, factory);
    }
